                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo base_url('login/registeradmin') ?>" method="post">
                                        <br>
                                        <?php echo $this->session->flashdata('gagal') ?>
                                        <br>
                                         <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" name="nama_admin" placeholder="Nama User" required>
                                        </div>
                                        <div class="form-group">
