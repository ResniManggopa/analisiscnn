                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img width="100%" style="padding-left: 30px; padding-top: 100px;" src="<?= base_url('assets/image/logo-kampus-merdeka.webp') ?>">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Aplikasi Analisis Sentimen MBKM</h1>
                                    </div>
                                    <form class="user" action="<?php echo base_url('login/do_login') ?>" method="post">
                                        <br>
                                        <?php echo $this->session->flashdata('gagal') ?>
                                        <?php echo $this->session->flashdata('aktif') ?>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('login/register') ?>">Daftar akun</a>
                                    </div>
                                </div>
                            </div>
                        </div>
